 ...
 *         &lt;element name="cancelPolicy" type="{http://bmc.com/ao/xsd/2008/09/soa}CancelPolicy"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(required = true, defaultValue = "WITH_COMPENSATION")
    ...
    /**
     * Ruft den Wert der cancelPolicy-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link CancelPolicy }
    ...
    /**
     * Legt den Wert der cancelPolicy-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link CancelPolicy }
     *     
     */
    public void setCancelPolicy(CancelPolicy value) {
